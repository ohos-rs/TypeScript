...
const (
	...
	SymbolFlagsAnnotation             SymbolFlags = 1 << 31                             // ETS annotation identity, also carries Class
	SymbolFlagsAll                    SymbolFlags = (1<<30 - 1) | SymbolFlagsAnnotation // All flags except SymbolFlagsGlobalLookup
